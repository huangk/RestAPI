...
Note: "service_key to username" mapping table is defined as the 'serviceAuth' collections of Mongodb. "auth_token to user" mapping is defined as the hash map inside the Java 'Authenticator' Object. Because the "auth_token" is the running time session data. 
